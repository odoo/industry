...
class ActionServerTestCase(TransactionCase):
    ...
    def test_wi_prices_correctly_computed(self):
        ...
        self.assertEqual(self.test_product.standard_price, 100.0, "The product cost should be updated when the work item cost is updated")
        self.assertEqual(self.test_product.lst_price, 400.0, "The product price should be updated when the work item price is updated")
    ...
    def test_sale_order_line_price_update_when_work_item_price_updated(self):
        ...
        self.assertEqual(new_work_item.x_unit_margin, 0.5, "The margin of work item is not computed correctly: it should be equal to 1.0 at this point")
